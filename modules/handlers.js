...
export function calculateHandler(firstNumber, secondNumber, operation, results) {
    const value1 = Number(firstNumber.value);
    const value2 = Number(secondNumber.value);
